    ...
    render() {
        return (
            <div>
                ...
                {Object.keys(this.props.story).length ? this.props.allComments.map((commentObj) => <SingleComment key={`${commentObj.content}_${new Date().getTime()}`} commentObj={commentObj} />) : 'Loading Comments'}
